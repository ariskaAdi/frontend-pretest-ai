    ...
    return (
      <div className="flex flex-col items-center justify-center py-40 max-w-md mx-auto text-center animate-in fade-in slide-in-from-bottom-4">
        ...
        <p className="text-gray-500 mb-8 leading-relaxed">
          Sabar ya! AI kami sedang menganalisis modul Anda untuk membuat
          ringkasan terbaik. Halaman ini akan terupdate otomatis saat selesai.
        </p>
      ...
      <div className="flex justify-center pt-8">
        <div className="text-center space-y-4">
          <p className="text-sm text-gray-500 italic">
            &quot;Paham materi adalah kunci sukses mengerjakan quiz.&quot;
          </p>
