...
import { Sparkles, Shield, Clipboard, FileText, CreditCard } from 'lucide-react'
    ...
    <div className="relative overflow-hidden bg-primary rounded-3xl p-8 mb-8 shadow-lg shadow-primary/20 group">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
             ...
             {user.role === 'admin' ? (
                <div className="bg-white/10 backdrop-blur-md rounded-full px-4 py-1.5 flex items-center gap-2 border border-white/10 group/item hover:bg-white/20 transition-colors">
                  ...
                  <span className="text-sm font-semibold text-white">Admin — Unlimited Access</span>
                </div>
             ) : (
               <>
                 ...
                 <div className={cn(
                    ...
                    user.quiz_quota === 0 ? "bg-red-500/30 border-red-400/40" : "bg-white/10 border-white/10 hover:bg-white/20"
                  )}>
                 ...
                 <div className={cn(
                    "backdrop-blur-md rounded-full px-4 py-1.5 flex items-center gap-2 border transition-colors",
                    user.summarize_quota === 0 ? "bg-red-500/30 border-red-400/40" : "bg-white/10 border-white/10 hover:bg-white/20"
                  )}>
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-center shrink-0">
          {user.role !== 'admin' && (user.quiz_quota === 0 || user.summarize_quota === 0) && (
            <a
