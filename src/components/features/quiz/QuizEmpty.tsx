  ...
  return (
    <Card className="flex flex-col items-center justify-center p-12 py-20 bg-gray-50 border-dashed border-2 border-gray-300 shadow-sm rounded-3xl animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <p className="text-gray-400 text-center max-w-sm mb-8">
        Anda belum pernah mengerjakan quiz apapun. Pilih salah satu modul Anda
        dan mulai uji pemahaman Anda sekarang!
      </p>
      <Link href="/modules">
        <Button className="rounded-xl px-8 font-bold">Pilih Modul</Button>
      </Link>
    </Card>
  );
}
