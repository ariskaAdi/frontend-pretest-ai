...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  ...
  const toast = React.useMemo(
    () => ({
      success: (message: string, duration?: number) => show({ message, variant: 'success', duration }),
      error: (message: string, duration?: number) => show({ message, variant: 'error', duration }),
      warning: (message: string, duration?: number) => show({ message, variant: 'warning', duration }),
      info: (message: string, duration?: number) => show({ message, variant: 'info', duration }),
      show,
    }),
    [show]
  )
